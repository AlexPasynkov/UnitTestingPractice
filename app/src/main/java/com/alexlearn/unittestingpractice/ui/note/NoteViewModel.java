...
import com.alexlearn.unittestingpractice.util.DateUtil;
...
public class NoteViewModel extends ViewModel {
    ...
    //Cancel data transfer if user decides to update to during data transfer
    ...
    //Convert Flowable to LiveData, to observe it in UI
